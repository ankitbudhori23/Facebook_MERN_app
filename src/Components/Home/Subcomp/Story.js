...
<Box className="story noStory">
  <img className="storyImg" src="" alt="not available" width="100%" />
  <Box
    className="Add"
    display="flex"
...
<Box className="story">
  <img
    className="storyImg"
    alt="not available"
    src="https://cdn.pixabay.com/photo/2013/05/30/18/21/cat-114782_960_720.jpg"
    width="100%"
  />
...
<Box className="story">
  <img
    className="storyImg"
    alt="not available"
    src="https://cdn.pixabay.com/photo/2022/03/06/03/18/friends-7050708_960_720.jpg"
    width="100%"
  />
...
<Box className="story">
  <img
    className="storyImg"
    alt="not available"
    src="https://cdn.pixabay.com/photo/2020/10/29/19/56/lighthouse-5697134_960_720.jpg"
    width="100%"
  />
...
<Box className="story">
  <img
    className="storyImg"
    alt="not available"
    src="https://cdn.pixabay.com/photo/2022/02/26/21/47/elephant-7036431_960_720.jpg"
    width="100%"
  />
  <h6 className="title">Rajiv</h6>
  <img
    src="https://images.news18.com/ibnlive/uploads/2022/01/army-day-16421788574x3.jpg"
    alt="username"
    width="30px"
    height="30px"
    className="userImg"
